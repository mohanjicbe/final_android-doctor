...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private TextView createDefaultTabView(Context context) {
        ...
        Typeface noto_reg = Typeface.createFromAsset(context.getAssets(), "fonts/NotoSans-Regular.ttf");
        Typeface noto_bold = Typeface.createFromAsset(context.getAssets(), "fonts/NotoSans-Bold.ttf");

        //textView.setTypeface(Typeface.DEFAULT_BOLD);
        textView.setTypeface(noto_bold);
