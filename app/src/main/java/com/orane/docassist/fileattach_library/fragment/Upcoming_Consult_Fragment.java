...
import com.orane.docassist.fileattach_library.Model.ItemCons;
...
import com.orane.docassist.fileattach_library.adapter.UpcomingConsRowAdapter;
...
public class Upcoming_Consult_Fragment extends Fragment {

    UpcomingConsRowAdapter objAdapter;
    ...
    JSONObject object;
    public String params, qtype;
    ProgressBar progressBar;
    long startTime;
    public String consid, str_response, flash_text;
    ...
    public Upcoming_Consult_Fragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.upcoming_consult,
                container, false);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Model.consid = tvid.getText().toString();
                Model.cons_view_type = "Upcoming";

                System.out.println("Fragment Model.consid------------" + Model.consid);
                System.out.println("Fragment Model.cons_view_type------------" + Model.cons_view_type);

                Intent intent = new Intent(getActivity(), UpcomingConsView.class);
                Bundle to_consview = new Bundle();
                to_consview.putString("consid", consid);
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (int_floor != 0 && (pagination)) {
                            ...
                            //-----------------------------------------------
                            params = Model.BASE_URL + "sapp/cinboxDoc?user_id=" + (Model.id) + "&browser_country=" + (Model.browser_country) + "&page=" + int_floor + "&token=" + Model.token;
                            System.out.println("Paginaton url----" + params);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (isInternetOn()) {
                    ...
                    System.out.println("Paginaton----" + params);
            ...
            try {
                ...
                if (json instanceof JSONObject) {
                    ...
                    for (int i = 0; i < jsonarr.length(); i++) {
                        ...
                        objItem.setApptdt(jsonobj1.getString("appt_datetime"));
    ...
    public void setAdapterToListview() {
        try {
            objAdapter = new UpcomingConsRowAdapter(getActivity(), R.layout.upcoming_row, arrayOfList);
