...
public class POD_NewQueriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pod_query_new);
...
/*      Model.id = "2479";
        ...
        if (Log_Status.equals("1")) {
            ...
            finishAffinity();
            intent = new Intent(POD_NewQueriesActivity.this, LoginActivity.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    ...
                    try {
                        Intent intent = new Intent(POD_NewQueriesActivity.this, POD_NewQueryViewActivity.class);
                        ...
                        intent.putExtra("finisher", new android.os.ResultReceiver(null) {
                            ...
                            protected void onReceiveResult(int resultCode, Bundle resultData) {
                                POD_NewQueriesActivity.this.finish();
                            }
                        });
...
/*                        //----------------------- Doctor Inbox -------------------------------
                ...
                if (json instanceof JSONObject) {
                    ...
                    if (jobject.has("token_status")) {
                        ...
                        if (token_status.equals("0")) {
                            ...
                            finishAffinity();
                            Intent intent = new Intent(POD_NewQueriesActivity.this, LoginActivity.class);
                            startActivity(intent);
                            finish();
                        }
                    }
    ...
    public void setAdapterToListview() {
        try {
            objAdapter = new NewQueryListAdapter(POD_NewQueriesActivity.this, R.layout.pod_query_new_row, arrayOfList);
    ...
    public void go_back_msg() {
        ...
        //---------------- Dialog------------------------------------------------------------------
        final MaterialDialog alert = new MaterialDialog(POD_NewQueriesActivity.this);
        alert.setTitle("Oops.!");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_wallet) {
            Intent i = new Intent(POD_NewQueriesActivity.this, MyWalletActivity.class);
            startActivity(i);
            return true;
        }
        ...
        if (id == R.id.csupport) {
            Intent i = new Intent(POD_NewQueriesActivity.this, CommonActivity.class);
    ...
    public void show_guidelines() {
        ...
        try {
            ...
            final MaterialDialog alert = new MaterialDialog(POD_NewQueriesActivity.this);
            View view = LayoutInflater.from(POD_NewQueriesActivity.this).inflate(R.layout.answeringgudlines, null);
            alert.setView(view);
    ...
    public void show_tips() {
        ...
        try {
            ...
            final MaterialDialog alert = new MaterialDialog(POD_NewQueriesActivity.this);
            View view = LayoutInflater.from(POD_NewQueriesActivity.this).inflate(R.layout.tipstoearning, null);
            alert.setView(view);
    ...
    private class JSON_canianswer extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new SpotsDialog(POD_NewQueriesActivity.this);
            ...
            try {
                ...
                if (jsonobj_canisnaswer.has("token_status")) {
                    ...
                    if ((answering_status).equals("0")) {
                        ...
                        Intent intent = new Intent(POD_NewQueriesActivity.this, NewQueryViewActivity.class);
                        intent.putExtra("followupcode", followcode_text);
                        intent.putExtra("pat_location", pat_location);
                        intent.putExtra("str_price", str_price);
                        intent.putExtra("qtype", "new_query");
    ...
    class JSON_POD_list extends AsyncTask<JSONObject, Void, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(POD_NewQueriesActivity.this);
