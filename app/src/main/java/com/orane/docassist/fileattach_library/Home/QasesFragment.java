...
import com.orane.docassist.Qases_View_Activity;
...
import com.orane.docassist.fileattach_library.adapter.QasesListAdapter;
...
public class QasesFragment extends Fragment implements ObservableScrollViewCallbacks {
    Item objItem;
    List<Item> listArray;
    Toolbar toolbar;
    ...
    public static QasesFragment newInstance(int pageIndex) {
        QasesFragment contentFragment = new QasesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.qases_list, container, false);
        ...
        LinearLayout1 = (RelativeLayout) rootView.findViewById(R.id.LinearLayout1);
...
/*        try {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getActivity(), Qases_View_Activity.class);
                ...
                if (scrollState == SCROLL_STATE_IDLE) {
                    if (listView.getLastVisiblePosition() >= count - threshold) {
                        ...
                        if (int_floor != 0 && (pagination)) {
                            if (qtype.equals("myfeeds")) {
                                params = Model.BASE_URL + "sapp/caseList?page=" + int_floor + "&doctor_id=" + (Model.id) + "&token=" + Model.token;
                            } else {
                                params = Model.BASE_URL + "sapp/caseList?page=" + int_floor + "&token=" + Model.token;
                            }
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (isInternetOn()) {
                    ...
                    if (qtype.equals("myfeeds")) {
                        params = Model.BASE_URL + "sapp/caseList?page=1&doctor_id=" + (Model.id) + "&token=" + Model.token;
                    } else {
                        params = Model.BASE_URL + "sapp/caseList?page=1&token=" + Model.token;
                    }
...
/*        System.out.println("int i---------------------------" + i);
    ...
    public void setAdapterToListview() {
        ...
        objAdapter = new QasesListAdapter(getActivity(), R.layout.qases_row, arrayOfList);
