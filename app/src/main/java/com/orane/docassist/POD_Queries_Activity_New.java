...
import com.orane.docassist.fragment.POD_queries_Fragment;

import me.drakeet.materialdialog.MaterialDialog;


public class POD_Queries_Activity_New extends AppCompatActivity {

    private TabLayout tabLayout;
    private ViewPager viewPager;

    POD_queries_Fragment new_queries_fragment;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_wallet) {
            Intent i = new Intent(POD_Queries_Activity_New.this, MyWalletActivity.class);
            startActivity(i);
            return true;
        }
        ...
        if (id == R.id.csupport) {
            Intent i = new Intent(POD_Queries_Activity_New.this, CommonActivity.class);
    ...
    public void Setup_viewPager() {
        ...
        new_queries_fragment = new POD_queries_Fragment();
    ...
    public void show_tips() {
        ...
        try {
            ...
            final MaterialDialog alert = new MaterialDialog(POD_Queries_Activity_New.this);
            View view = LayoutInflater.from(POD_Queries_Activity_New.this).inflate(R.layout.tipstoearning, null);
            alert.setView(view);
    ...
    public void show_guidelines() {
        ...
        try {
            final MaterialDialog alert = new MaterialDialog(POD_Queries_Activity_New.this);
            View view = LayoutInflater.from(POD_Queries_Activity_New.this).inflate(R.layout.answeringgudlines, null);
            alert.setView(view);
