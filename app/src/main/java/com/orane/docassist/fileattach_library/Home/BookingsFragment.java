...
import com.orane.docassist.fileattach_library.Model.ItemConsUnConfirmed;
...
import com.orane.docassist.fileattach_library.adapter.UnconfirmedConsRowAdapter;
...
public class BookingsFragment extends Fragment {
    ...
    ListView listView;
    public String params, str_response,consid;
    ...
    public static BookingsFragment newInstance(int pageIndex) {
        BookingsFragment contentFragment = new BookingsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.unconfirmed_consult, container, false);
