...
public class MyPatientAddActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    Button btn_submit;
    public String ptype, pname, pemail, pmobno, get_pat_name, get_pat_email, get_pat_mobile, ccode_txt, ccode_val, status, cname, sstreet, clinic_street, edt_city, place_id_txt, clinic_id, clinic_name, clinic_geo;
    ...
    JSONObject adpatient_json, addpatient_jsonobj, jsonobj1c_cl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mypatientadd);
        ...
        if (ptype.equals("addpatient")) {
            mTitle.setText("Add a Patient");
            btn_done.setText("Add a Patient");
        } else {
            mTitle.setText("Invite a Patient");
            btn_done.setText("Invite a Patient");
        }
                ...
                if (isInternetOn()) {
                    ...
                    try {
                        if (pname.equals("")) edt_pname.setError("Patient Name cannot be empty");
                            ...
                            Model.mFirebaseAnalytics.logEvent("Add_New_patient", params);
                            //------------ Google firebase Analitics--------------------
    ...
    private class JSON_AddPatient extends AsyncTask<JSONObject, Void, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(MyPatientAddActivity.this);
    ...
    public void country_code() {
        ...
        try {
            ...
            ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(MyPatientAddActivity.this, android.R.layout.simple_spinner_item, categories);
