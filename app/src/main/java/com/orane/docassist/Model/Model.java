...
public class Model {
    ...
    public static String app_slno = "110";
    public static String app_ver = "2.7.4";
    public static String app_rel = "20-June-2019";

    public static String BASE_URL = "https://www.icliniq.com/";
    //public static String BASE_URL = "http://54.172.138.107/";
    //public static String BASE_URL = "http://192.168.0.107/projects/icliniq/web/index.php/";
